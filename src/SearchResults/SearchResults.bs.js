...
function generateSubstrings(s) {
  ...
  var substrings = generateSubstrings($$String.sub(s, 0, s.length - 1 | 0));
  return {
          hd: s,
          tl: substrings
        };
...
function filterExistingWords(w) {
  var match = localStorage.getItem(w);
  return match !== null;
}
...
function SearchResults(Props) {
  ...
  var onClickWord = Props.onClickWord;
  var results = data !== undefined ? Belt_SetString.toList(Trie$AmisMoedictRescript.collectWordsByPrefix(query, data)) : /* [] */0;
...
exports.merge = merge;
exports.generateSubstrings = generateSubstrings;
exports.filterExistingWords = filterExistingWords;
exports.make = make;
